...
function IconCV(props: React.SVGProps<SVGSVGElement>) {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            />
            <path
                d="M11 12.5C11 12.1022 10.842 11.7206 10.5607 11.4393C10.2794 11.158 9.89782 11 9.5 11C9.10218 11 8.72064 11.158 8.43934 11.4393C8.15804 11.7206 8 12.1022 8 12.5V15.5C8 15.8978 8.15804 16.2794 8.43934 16.5607C8.72064 16.842 9.10218 17 9.5 17C9.89782 17 10.2794 16.842 10.5607 16.5607C10.842 16.2794 11 15.8978 11 15.5M13 11L14.5 17L16 11"
                stroke="white"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
